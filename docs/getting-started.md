...
You can follow a few quick steps to install the Matano CLI and get up and running with Matano.
...
To install the Matano CLI for Linux, run:
...
To install the Matano CLI for Mac OS (x64), run:
